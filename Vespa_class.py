...
class SME():
    ...
    def __init__(self, parent, offspring_number, sigma, sigma_strategy, matrix_file, aa_excluded):
        """
        ...
        :param aa_matrix: [np array] amino acid similarity matrix, when 'grantham' is chosen, .
        :param aa_excluded: amino acids to exclude in generating the mutations.
        """
        self.parent = parent
        self.lambd = offspring_number
        self.sigma = sigma
        ...
        self.aa_matrix = np.genfromtxt(matrix_file, delimiter='\t', dtype=float, skip_header=True)
    ...
    def _mutate(self, parent, sigma, matrixfile, no_aa):
        """
